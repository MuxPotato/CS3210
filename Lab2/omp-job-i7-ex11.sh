...
#SBATCH --job-name=lab2-mmomp-i7-modified
#SBATCH --partition=i7-7700
#SBATCH --output=lab2_mmomp_%j-i7-modified.slurmlog
#SBATCH --error=lab2_mmomp_%j-i7-modified.slurmlog
...
echo "Compiling..."
srun g++ -fopenmp -o mm-omp mm-omp_ex11.cpp
